...
public class CommonInfoFeignInterceptor implements RequestInterceptor {
    private static final Logger LOGGER = LoggerFactory.getLogger(CommonInfoFeignInterceptor.class);
